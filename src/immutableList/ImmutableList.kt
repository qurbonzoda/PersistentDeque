...
public interface ImmutableList<out E>: List<E>, ImmutableCollection<E> {
    ...
    override fun addAll(elements: Collection<@UnsafeVariance E>): ImmutableList<E> // = super<immutableList.ImmutableCollection>.addAll(elements) as immutableList.ImmutableList
