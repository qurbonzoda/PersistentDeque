package immutableDeque.childCount16.bufferSize1024.persistentDeque
...
import immutableDeque.childCount16.bufferSize1024.constants.*
import immutableDeque.childCount16.bufferSize1024.level.DequeBottomLevel
import immutableDeque.childCount16.bufferSize1024.level.ImmutableLevel
import immutableDeque.childCount16.bufferSize1024.level.NonBottomLevel
import immutableDeque.childCount16.bufferSize1024.level.SubStackBottomLevel
import immutableDeque.childCount16.childCountToThePow
import java.util.*
...
//            assert(lowerSubStack == null)
    ...
    override fun get(index: Int): T {
        ...
        while (levelIterator.hasNext()) {
            ...
            val lhsSize = level.lhs.size * childCountToThePow(depth)
            val rhsSize = level.rhs.size * childCountToThePow(depth)
    ...
    fun checkInvariants(): PersistentDeque<T> {
