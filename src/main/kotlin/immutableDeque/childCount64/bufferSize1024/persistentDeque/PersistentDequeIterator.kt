...
import immutableDeque.childCount64.LOG_CHILD_COUNT
...
//        assert(index in 0..size)
    ...
    private fun setPreviousToTreeIterator() {
        ...
        treeIterator.setTree(previousTree, previousDepth, childCountToThePow(previousDepth))
