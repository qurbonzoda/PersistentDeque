package immutableDeque.smallDequeOptimization.arrayBuffer.bufferSize31S.constants

const val RED = 0
const val YELLOW = 1
const val GREEN = 2

const val MAX_BUFFER_SIZE = 31
const val RED_LOW = 0
...
const val FULL_UPPER_LEVEL_SHOULD_MOVE_TO_THIS_LEVEL = 20

const val EMPTY_UPPER_LEVEL_SHOULD_MOVE_FROM_THIS_LEVEL = 10     // count at this level
